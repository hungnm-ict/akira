...
totaln5Ctrls.controller('hiraLearnCtrl', function($scope, $routeParams, $http, dataService) {
    alert();
    $http({
        method: "GET",
 ...
 * @return {[type]}              [description]
 */
totaln5Ctrls.controller('hiraPictureCtrl', function($scope, $routeParams, $http, $sce, dataService) {
    $scope.course = "kana";
    $scope.lessonId = $routeParams.lessonId;
    $scope.partId = $routeParams.partId;
 ...
 * @return {[type]}              [description]
 */
totaln5Ctrls.controller('hiraWordCtrl', function($scope, $routeParams, $http, dataService) {
    $scope.lessonId = $routeParams.lessonId;
    $scope.partId = $routeParams.partId;
    $scope.choices = [];
    $scope.step = 0;
 ...
 * @return {[type]}              [description]
 */
totaln5Ctrls.controller('hiraConnectCtrl', function($scope, $routeParams, $http, dataService) {
    $scope.lessonId = $routeParams.lessonId;
    $scope.partId = $routeParams.partId;
    $scope.gameObject = {
        "life": 3,
...
totaln5Ctrls.controller('hiraWriteCtrl', function($scope, $routeParams, $http, dataService) {
...
totaln5Ctrls.controller('kataLearnCtrl', function($scope, $routeParams, $http, dataService) {
    $http({
        method: "GET",
        url: "../../data/kana/kana_type1_v2.0.json"
    }).success(function(data, status) {
 ...
 * @return {[type]}              [description]
 */
totaln5Ctrls.controller('kataPictureCtrl', function($scope, $routeParams, $http, $sce, dataService) {
    $scope.course = "kana";
    $scope.lessonId = $routeParams.lessonId;
    $scope.partId = $routeParams.partId;
 ...
 * @return {[type]}              [description]
 */
totaln5Ctrls.controller('kataWordCtrl', function($scope, $routeParams, $http, dataService) {
    $scope.lessonId = $routeParams.lessonId;
    $scope.partId = $routeParams.partId;
    $scope.choices = [];
    $scope.step = 0;
 ...
 * @return {[type]}              [description]
 */
totaln5Ctrls.controller('kataConnectCtrl', function($scope, $routeParams, $http, dataService) {
    $scope.lessonId = $routeParams.lessonId;
    $scope.partId = $routeParams.partId;
    $scope.gameObject = {
        "life": 3,

...
/*===========================================================
=            Controller for toeic500 - Vocab game            =
===========================================================*/
...
/*=============================================================
=            Controller for toeic500 - Grammar game            =
=============================================================*/
...
toeic500Ctrls.controller('grammarListenCtrl', function($scope, $routeParams, $http) {
    ...
    $http({
        method: "GET",
        url: "../../data/toeic500/grammar/json/type1.json"
    }).success(function(data, status) {
...
// toeic500Ctrls.controller('kanaCtrl', function($scope, $routeParams, $location, $http) {
//     $scope.course = "kana";
//     $scope.lessonId = $routeParams.lessonId;
...
// toeic500Ctrls.controller('kanaLearnCtrl', function($scope, $routeParams, $http, dataService) {
//     $http({
//         method: "GET",
...
// toeic500Ctrls.controller('kanaPictureCtrl', function($scope, $routeParams, $http, $sce, dataService) {
//     $scope.course = "kana";
//     $scope.lessonId = $routeParams.lessonId;
//     $scope.partId = $routeParams.partId;
...
// toeic500Ctrls.controller('kanaWordCtrl', function($scope, $routeParams, $http, dataService) {
//     $scope.lessonId = $routeParams.lessonId;
//     $scope.partId = $routeParams.partId;
//     $scope.choices = [];
//     $scope.step = 0;
...
// toeic500Ctrls.controller('kanaConnectCtrl', function($scope, $routeParams, $http, dataService) {
//     $scope.lessonId = $routeParams.lessonId;
//     $scope.partId = $routeParams.partId;
//     $scope.gameObject = {
//         "life": 3,
...
// toeic500Ctrls.controller('kanaWriteCtrl', function($scope, $routeParams, $http, dataService) {
